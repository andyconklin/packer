...
int main() 
{
    ...
    BYTE key[] = { 0xD7,0xB0,0x04,0x02,0x65,0x9B,0xA2,0xAB,0xD2,0xCB,0x0D,0xB2,0x7F,0xA2,0xB6,0x56 };
    ...
    VBYTES enc_appfile = ReadIntoBuffer("C:\\Users\\Andy\\Desktop"
        "\\JNUSTool\\tmp_000500301001620A\\000000ad.app");
    ...
    std::ofstream outfile("C:\\Users\\Andy\\Desktop\\000000ad.app.dec", std::ofstream::binary);
    outfile.write((const char *)dec_appfile.data(), (std::streamsize)dec_appfile.size());
    outfile.close();
